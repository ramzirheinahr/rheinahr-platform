...
const styles = StyleSheet.create({
  ...
  tableRowSunday: { flexDirection: "row", borderBottomWidth: 0.5, borderBottomColor: "#d1d5db", backgroundColor: "#fef08a" },
  col: { padding: 4, borderRightWidth: 0.5, borderRightColor: "#d1d5db", justifyContent: "center" },
